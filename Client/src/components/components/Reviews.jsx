...
const Reviews = ({autoslides = false, interval=3000}) => {
    ...
    // const options = {
    //   method: 'GET',
    //   url: 'https://api.content.tripadvisor.com/api/v1/location/27451039/reviews',
    ...
    <div className='reviews__container'>
        ...
        <div className="slides-btn__container-review">
                <button onClick={prev} className='carousel__btn-review'>
                   <SlArrowLeft style={{color: '#fff', fontSize: '3rem'}} />
                </button>
                <button onClick={next} className='carousel__btn-review'>
                    <SlArrowRight style={{color: '#fff', fontSize: '3rem'}} />
                </button>
        </div>
    </div>
  )
